<%@ Page Language="C#" MasterPageFile="~/DetailsMaster.master" AutoEventWireup="true" CodeFile="Educators.aspx.cs" Inherits="Educators"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderColor="White"
        ...
        <Columns>
            <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    <center>
                        <img alt='<%# Eval("Name") %> <%# Eval("Surname") %>' class="img" src='Handler.ashx?TargetSize=120&EducatorID=<%# Eval("ID") %>'
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetEducators"
        TypeName="EducatorManager"></asp:ObjectDataSource>
</asp:Content>
