<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Members.aspx.cs" Inherits="Admin_Members" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <ItemTemplate>
                <table align="center" border="0" cellpadding="0" cellspacing="0" class="photo-frame">
                    ...
                    <tr>
                        ...
                        <td>
                            <img src='../Handler.ashx?TargetSize=120&MemberID=<%# Eval("ID") %>' style="border: 2px solid white;"
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="RemoveMember"
        InsertMethod="AddMember" SelectMethod="GetMembers" TypeName="MemberManager"
        UpdateMethod="EditMember">
        <DeleteParameters>
