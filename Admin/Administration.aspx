<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Administration.aspx.cs" Inherits="Admin_Administration" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <asp:TextBox ID="SurnameTextBox" runat="server" Text='<%# Bind("Surname") %>' MaxLength="20"></asp:TextBox></td>
                ...
                <tr>
                    <td style="width: 120px">
                        Açýklama:</td>
                    <td>
            <asp:TextBox ID="DescriptionTextBox" runat="server" Text='<%# Bind("Description") %>' Height="49px" MaxLength="100" TextMode="MultiLine" Width="148px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td style="width: 120px">
                    </td>
    ...
    <asp:GridView ID="GridView1" DataKeyNames="ID" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" AllowPaging="True">
        <Columns>         
            ...
            <ItemTemplate>
                <table align="center" border="0" cellpadding="0" cellspacing="0" class="photo-frame">
                    ...
                    <tr>
                        ...
                        <td>
                            <img src='../Handler.ashx?TargetSize=120&AdministratorID=<%# Eval("ID") %>' style="border: 2px solid white;"
            ...
            <asp:TemplateField ConvertEmptyStringToNull="False" HeaderText="Soyadý" SortExpression="Surname">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox2" runat="server" MaxLength="20" Text='<%# Bind("Surname") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField ConvertEmptyStringToNull="False" HeaderText="A&#231;ýklama" SortExpression="Description">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox3" runat="server" MaxLength="100" Text='<%# Bind("Description") %>'
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="RemoveAdministrator"
        InsertMethod="AddAdministrator" SelectMethod="GetAdministrators" TypeName="AdministrationManager"
        UpdateMethod="EditAdministrator">
        <DeleteParameters>
