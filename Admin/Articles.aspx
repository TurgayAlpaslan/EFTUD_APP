<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Articles.aspx.cs" Inherits="Admin_Articles" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" DataKeyNames="ArticleID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" AllowPaging="True" PageSize="5">
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
                    <a href="AddUpdateArticle.aspx?ArticleID=<%# Eval("ArticleID") %>">Deðiþtir</a>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Baþlýk" SortExpression="Title">
                <EditItemTemplate>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAllArticles"
        ...
        <SelectParameters>
            <asp:QueryStringParameter Name="UserID" QueryStringField="UserID" Type="Int32" ConvertEmptyStringToNull="False" />
        </SelectParameters>
        <DeleteParameters>
