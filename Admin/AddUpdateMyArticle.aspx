<%@ Page Language="C#" MasterPageFile="~/Admin/AuthorMaster.master" AutoEventWireup="true" CodeFile="AddUpdateMyArticle.aspx.cs" Inherits="Admin_AddUpdateMyArticle" Title="Untitled Page" %>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Title" ErrorMessage="Bir başlık girmelisiniz." ValidationGroup="edit" Display="Dynamic"></asp:RequiredFieldValidator></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="Title"
                            Display="Dynamic" ErrorMessage="Başlık girmelisiniz." ValidationGroup="insert"></asp:RequiredFieldValidator></td>
                </tr>
                <tr>
                    <td style="width: 120px" valign="top">
                        İçerik:</td>
